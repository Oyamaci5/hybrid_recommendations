"""
HHO-EO-MF method: Matrix Factorization with hybrid HHO+EO optimizer.

Tamamen meta-sezgisel bir işbirlikçi filtreleme yaklaşımı:
  - MFModel: U, V latent faktörleri
  - HHOEOOptimizer: U, V'yi global olarak optimize eder
...
from optimizers.hho_eo import HHOEOOptimizer
from core.metrics import evaluate_predictions


class HHOEOMF:
    """
    HHO-EO-MF method combining MF model with hybrid HHO+EO optimizer.
    """
    ...
    def fit(
        ...
        """
        Train MF model using HHO+EO optimizer.

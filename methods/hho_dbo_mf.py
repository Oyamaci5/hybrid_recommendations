"""
HHO-DBO-MF method: Matrix Factorization with hybrid HHO+DBO optimizer.

Tamamen meta-sezgisel bir işbirlikçi filtreleme yaklaşımı:
  - MFModel: U, V latent faktörleri
  - HHODBOOptimizer: U, V'yi global olarak optimize eder
...
from optimizers.hho_dbo import HHODBOOptimizer
from core.metrics import evaluate_predictions


class HHODBOMF:
    """
    HHO-DBO-MF method combining MF model with hybrid HHO+DBO optimizer.
    """
    ...
    def __init__(
        ...
        self.optimizer = HHODBOOptimizer(
            n_agents=n_agents,
    ...
    def fit(
        ...
        """
        Train MF model using HHO+DBO optimizer.
        """
